          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full futuristic-tabs">
            ...
            <TabsContent value="dashboard" className="bg-magnoos-dark space-y-8 bg-magnoos-dark"bg-magnoos-dark >
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                ...
                <Card className="bg-magnoos-dark border-magnoos-secondary/20">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <Card className="bg-magnoos-dark border-magnoos-accent/20">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <Card className="bg-magnoos-dark border-red-500/20">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <Card className="bg-magnoos-dark border-green-500/20">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
